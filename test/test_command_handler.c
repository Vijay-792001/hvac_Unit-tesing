#include "unity.h" #include "command_handler.h" #include "mock_stm32f4xx_hal.h"

void setUp(void) {} void tearDown(void) {}

void test_command_handler_CH_01(void) { uint8_t cmd = 123; // intentionally non-zero uint8_t rx = '0'; extern UART_HandleTypeDef huart2;
...
void test_command_handler_CH_05(void) { uint8_t cmd = 11; uint8_t rx = 0; // value ignored for this test extern UART_HandleTypeDef huart2;
